"""MES-007 expanded practice and exhaustive state evidence. This verifies behavior/coverage, not teaching quality."""
import hashlib
import json
...
OUT=ROOT/'tests/evidence/mes-007/drills'
    ...
    for width in [1440,360]:
        ...
        for course,lessons in SCOPE.items():
            for lesson in lessons:
                ...
                page.locator('.evidence-drill').evaluate_all('(els)=>els.forEach(e=>e.open=true)')
