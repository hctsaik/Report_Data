...
normalNodes.finish=node('L023 的六站旅程完成。',{current:'結束',done:STEPS.map(x=>x.id),status:'Finished',recipe:'不適用'},[],'Flow 定義沒有被改寫；L023 留下6次完成紀錄，最後才標為 Finished（本教學 Flow 完成，不代表 Lot E 已出貨）。');
